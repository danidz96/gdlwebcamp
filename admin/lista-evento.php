                ...
                <?php
                    ...
                    while($eventos = $resultado->fetch_assoc() ) { ?>
                      <tr>
                          ...
                          <td>
                            <a href="editar-evento.php?id=<?php echo $eventos['id_evento'] ?>" class="btn bg-orange btn-flat margin">
                              <i class="fa fa-pencil"></i>
                            </a>
                            <a href="#" data-id="<?php echo $eventos['id_evento']; ?>" data-tipo="evento" class="btn bg-maroon bnt-flat margin borrar_registro">
